...
--
-- Hôte : db
-- Généré le : lun. 30 août 2021 à 14:34
...
CREATE TABLE `commande` (
  ...
  `estimation_delais_livraison` time NOT NULL,
...
INSERT INTO `commande` (`id`, `client_utilisateur_id`, `reglement_id`, `adresse_client_id`, `estimation_delais_livraison`, `heure_prise_en_charge`, `heure_remise_client`, `livreur_utilisateur_id`, `statut_commande_id`) VALUES
(1, 6, 1, 2, '00:18:55', '2021-08-09 11:45:58', '2021-08-09 11:59:25', 2, 3),
(2, 5, 2, 1, '00:15:25', '2021-08-09 11:53:18', '2021-08-09 12:17:01', 2, 3),
(3, 5, 3, 9, '00:13:02', '2021-08-10 11:35:18', '2021-08-10 12:08:33', 3, 3);
...
(3, 1, 'Linguini alle vongole', '/path/to/file/prod003.jpg', 'Recette traditionelle napolitaine de pates accompagnées de palourdes, piments, tomates cerises confites et aromates', NULL, '7.50'),
