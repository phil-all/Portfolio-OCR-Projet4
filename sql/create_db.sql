...
CREATE TABLE IF NOT EXISTS `expressfood`.`commande` (
  ...
  PRIMARY KEY (`id`, `client_utilisateur_id`, `reglement_id`, `adresse_client_id`),
  ...
  INDEX `fk_commande_reglement1_idx` (`reglement_id` ASC, `client_utilisateur_id` ASC),
  ...
  CONSTRAINT `fk_commande_reglement1`
    FOREIGN KEY (`reglement_id` , `client_utilisateur_id`)
...
CREATE TABLE IF NOT EXISTS `expressfood`.`produit` (
  ...
  PRIMARY KEY (`id`, `ligne_menu_du_jour_id`, `fiche_produit_id`, `cuisinier_utilisateur_id`),
  INDEX `fk_produit_ligne_menu_du_jour1_idx` (`ligne_menu_du_jour_id` ASC, `fiche_produit_id` ASC),
  ...
  CONSTRAINT `fk_produit_ligne_menu_du_jour1`
    FOREIGN KEY (`ligne_menu_du_jour_id` , `fiche_produit_id`)
  ...
  CONSTRAINT `fk_produit_commande1`
    ...
    REFERENCES `expressfood`.`commande` (`id` , `client_utilisateur_id` , `reglement_id` , `adresse_client_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
